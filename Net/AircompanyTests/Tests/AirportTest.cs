...
namespace AircompanyTests.Tests
{
    ...
    public class AirportTest
    {
        ...
        [Test]
        public void FindTransportMilitaryPlane() //MyTest1
        {
            Airport airport = new Airport(planes);

            bool hasMilitaryTransportPlane = airport.GetTransportMilitaryPlanes().Any(plane => plane.GetPlaneType() == MilitaryType.Transport);
            Assert.IsTrue(hasMilitaryTransportPlane);
        }

        [Test]
        public void FindPlaneWithMaxPassenersCapacityTest()
        {
            Airport airport = new Airport(planes);
